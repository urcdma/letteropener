...
} = require('./appearance/StyleThemeFactory');

const { buildSVGObjectsTree } = require('./svgObjectsBuilder');
const { traversal } = require('shared/utils/traversal');
const { flatTree } = require('shared/utils/flatten');
const { logError } = require('shared/utils/logger');

const ShapesTreeEditor = svgObjectsTree => {
...
const SVGRender = (customStyleTheme = {}) => {
